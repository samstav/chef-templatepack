...
# knife rackspace server create -N"dev-1" -r"recipe[|{ cookbook['name'] }|], recipe[|{ cookbook['name'] }|::role_web]," -E"dev" -I"598a4282-f14b-4e50-af4c-b3e52749d9f9" -f"performance1-4" --no-tcp-test-ssh --ssh-wait-timeout 60 --secret-file path/to/secret --network "dev" --rackspace-version v2
